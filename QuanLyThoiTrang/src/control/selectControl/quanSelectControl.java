...
public class quanSelectControl implements Initializable {
	@FXML
	...
	void clickButton(ActionEvent event) throws IOException {
		...
		if (mySelect.equals("add")) {
			...
			Parent home = FXMLLoader.load(getClass().getResource("/view/add/quanAdd.fxml"));
		...
		if (mySelect.equals("del")) {
			...
			Parent home = FXMLLoader.load(getClass().getResource("/view/del/quanDel.fxml"));
			Stage stage1 = new Stage();
			stage1.setScene(new Scene(home));
			stage1.show();
		}
		if (mySelect.equals("modify")) {
			...
			Parent home = FXMLLoader.load(getClass().getResource("/view/modify/quanModify.fxml"));
			Stage stage1 = new Stage();
			stage1.setScene(new Scene(home));
			stage1.show();
		}
